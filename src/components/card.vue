<template>
    <div class="card col-xl-4 col-lg-5 col-sm-8 col-12 justify-content-center position-relative border-0">
          <div class="cardclass rounded-4 d-flex justify-content-center align-items-center" :style="change" :class="{'soldout' :card.inventory === false}">
          ...
          <div class="card-body">
              ...
              <p class="text-center fw-bold mt-3 card-title">{{ card.name }}</p>
              <p class="text-center">
